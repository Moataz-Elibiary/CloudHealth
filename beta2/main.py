#!/usr/bin/env python3
"""
ClusterPulse main entry point.
Called by the bootstrapper after version sync and credential setup.
Also usable directly for development: python main.py
"""
...
def main():
    ...
    if not app_config.clusters:
        print("[ERROR] No clusters found in inventory.")
        sys.exit(1)
